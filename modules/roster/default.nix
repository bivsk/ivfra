_: {
  ...
  manifest = {
    name = "roster";
    description = "Holistic user management with position-based access control and home environment configuration";
    categories = [ "System" ];
  };
      ...
      { settings, machine, ... }:
      {
        nixosModule =
          ...
          let
            ...
            inherit (settings) positionDefinitions;
            ...
            imports = lib.optionals homeManagerEnabled [
              inputs.home-manager.nixosModules.home-manager
              {
                home-manager = lib.mkMerge [
                  ...
                  {
                    inherit (settings.homeManagerOptions)
                      useGlobalPkgs
                      useUserPackages
                      verbose
                  ...
                  (lib.mkIf (settings.homeManagerOptions.backupFileExtension != null) {
                    inherit (settings.homeManagerOptions) backupFileExtension;
                  })
